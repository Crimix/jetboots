...
//            INetwork network = NetworkUtils.getNetworkFromNode(NetworkUtils.getNodeFromTile(nodeWorld.getBlockEntity(new BlockPos(getX(helmet), getY(helmet), getZ(helmet)))));
//
//            if (network != null) {
...
//                }
//
//                API.instance().getGridManager().openGrid(WirelessCraftingUpgradeGridFactory.ID, (ServerPlayer) player, helmet, -1);
//                return;
//            }
//        }
//
