...
//import static com.black_dog20.jetboots.common.util.UpgradeFunctionUtil.createApplyUpgradeBoolean;
//import static com.black_dog20.jetboots.common.util.UpgradeFunctionUtil.createValidateUpgradeBoolean;
//
...
//            WIRELESS_RANGE_UPGRADE = items.register("wireless_range_upgrade_rs", () -> new UpgradeItem(UpgradeItem.Type.HELMET, TranslationHelper.Compat.WIRELESS_RANGE_UPGRADE_INFO, createRangeUpgradeFunction(), createRangeUpgradeValidateFunction(), ModItems.ITEM_GROUP.stacksTo(4)));
//        }
//    }
//
