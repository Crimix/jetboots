...
public class WirelessCraftingGrid extends WirelessGrid {
    ...
    private AbstractContainerMenu craftingContainer = new AbstractContainerMenu(null, 0) {
        ...
        public ItemStack quickMoveStack(Player pPlayer, int pIndex) {
            return transferManager.transfer(pIndex);
        }
    ...
    private CraftingContainer matrix = new TransientCraftingContainer(craftingContainer, 3, 3);
    ...
    public void onCraftingMatrixChanged() {
        ...
        if (currentRecipe == null) {
            ...
            result.setItem(0, currentRecipe.assemble(matrix, world.registryAccess()));
        }
