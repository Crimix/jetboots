...
public class ModItems {
    ...
    public static final RegistryObject<Item> ULTIMATE_CONVERTER_UPGRADE = ITEMS.register("ultimate_converter_upgrade", ()-> new ConverterUpgradeItem(0.5D, Tooltips.ULTIMATE_CONVERTER_UPGRADE));
