...
public class ModItems {
    ...
    public static final RegistryObject<Item> BASIC_CONVERTER_UPGRADE = ITEMS.register("basic_converter_upgrade", () -> new ConverterUpgradeItem(0.8D, Tooltips.BASIC_CONVERTER_UPGRADE));
    public static final RegistryObject<Item> ADVANCED_CONVERTER_UPGRADE = ITEMS.register("advanced_converter_upgrade", () -> new ConverterUpgradeItem(0.7D, Tooltips.ADVANCED_CONVERTER_UPGRADE));
    public static final RegistryObject<Item> ELITE_CONVERTER_UPGRADE = ITEMS.register("elite_converter_upgrade", () -> new ConverterUpgradeItem(0.5D, Tooltips.ELITE_CONVERTER_UPGRADE));
    public static final RegistryObject<Item> ULTIMATE_CONVERTER_UPGRADE = ITEMS.register("ultimate_converter_upgrade", () -> new UltimateConverterUpgradeItem(0.4D, Tooltips.ULTIMATE_CONVERTER_UPGRADE));
