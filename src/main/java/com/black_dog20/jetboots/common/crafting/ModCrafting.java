...
public class ModCrafting {
    ...
    public static final RegistryObject<IRecipeSerializer<?>> JETBOOTS_SHAPED_NBT = RECIPE_SERIALIZERS.register("jetboots_shaped_nbt", JetBootsShapedNBTRecipe.factory());
