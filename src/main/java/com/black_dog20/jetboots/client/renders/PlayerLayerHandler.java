...
public class PlayerLayerHandler {
    ...
    public static void setupRenders(FMLClientSetupEvent event) {
        ...
        playerRendererDefault.addLayer(new GuardianLayerRender<>(playerRendererDefault, false));
        playerRendererSlim.addLayer(new GuardianLayerRender<>(playerRendererSlim, true));
    }
}
